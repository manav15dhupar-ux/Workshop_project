...
The workshop focused on building a Retrieval-Augmented Generation (RAG) based
AI Knowledge Agent using the Gemini API and practical system design concepts.

Through this hands-on session, I gained exposure to:
...
Grateful for the structured learning experience and practical insights provided during the workshop.
